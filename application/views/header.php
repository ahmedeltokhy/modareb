                ...
                <header>
                    ...
                    <ul class="main-nav">
                        ...
                        <li class="main-nav__item">
                            <a class="main-nav__item-link" href="<?= (get_cookie('lang') == 'ar') ? site_url('site/lang/en') : site_url('site/lang/ar') ?>">
                                <span class="main-nav__item-icon-wrapper">
                                    <i class="main-nav__item-icon icon-earth"></i>
                                </span>
                                <span class="main-nav__item-content"><?= get_cookie('lang') == 'ar' ? 'English' : 'عربى' ?></span>
                            </a>
                        </li>
                    </ul>
