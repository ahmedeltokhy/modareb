...
define('NOTIFICATION_SUBJECT', 'Modareb: Contact form notification');
define('NOTIFICATION_EMAIL_ADDRESS', 'aaa.computerscience@gmail.com'); // for example: 'your.email@host.com'
